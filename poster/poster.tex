...
\fcolorbox{headerblue}{lightblue!40}{%
    \parbox{0.9\textwidth}{\centering \Large\textbf{Faster learning through collaboration while maintaining safety!}}%
}
\end{center}
\vspace{0.4cm}
...
\end{equation*}
\begin{itemize}
  \item $m_k(P)$ and $\sigma_k(P)$ are the GP posterior mean and uncertainty over a model-score (e.g., predicted advantage).
