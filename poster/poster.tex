...
\textbf{Domain:} Racetrack-T1 Conf-MDP, [0.1cm]
...
\begin{center}
\includegraphics[width=0.97\linewidth]{sample_efficiency.png}
\end{center}
\end{block}
\end{column}
...
\begin{center}
\includegraphics[width=0.97\linewidth]{convergence_safety.png}
\end{center}
\end{block}
\end{column}
...
\begin{center}
\includegraphics[width=0.95\linewidth]{mc_vs_true.png}
\end{center}
\end{block}
\end{column}
