...
echo "Environment: FrozenLake-4x4 (fast standard benchmark)"
echo "Seeds: 0, 1, 2"
echo ""
...
python examples/experiment_runner.py \
    ...
    --environment frozen_lake_4x4 \
    --seeds 0 1 2 \
    --project sa-pmi-sweep-linear-budget \
    2>&1 | tee -a ${LOG_FILE}
...
python examples/experiment_runner.py \
    ...
    --environment frozen_lake_4x4 \
    --seeds 0 1 2 \
    --project sa-pmi-sweep-linear-warmup \
    2>&1 | tee -a ${LOG_FILE}
...
python examples/experiment_runner.py \
    ...
    --environment frozen_lake_4x4 \
    --seeds 0 1 2 \
    --project sa-pmi-sweep-linear-curriculum \
    2>&1 | tee -a ${LOG_FILE}
...
python examples/experiment_runner.py \
    ...
    --environment frozen_lake_4x4 \
    --seeds 0 1 2 \
    --project sa-pmi-sweep-exp-budget \
    2>&1 | tee -a ${LOG_FILE}
...
python examples/experiment_runner.py \
    ...
    --environment frozen_lake_4x4 \
    --seeds 0 1 2 \
    --project sa-pmi-sweep-exp-warmup \
    2>&1 | tee -a ${LOG_FILE}
...
python examples/experiment_runner.py \
    ...
    --environment frozen_lake_4x4 \
    --seeds 0 1 2 \
    --project sa-pmi-sweep-exp-curriculum \
    2>&1 | tee -a ${LOG_FILE}
